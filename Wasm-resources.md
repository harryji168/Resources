...
The main goal of WebAssembly is to enable high-performance applications on web pages.[7] It is an open standard [8][9] and aims to support any language on any operating system,[10] and in practice all of the most popular languages already have at least some level of support.
...
*   [wasm\_lua - Lua VM running in a WASM environment](https://github.com/vvanders/wasm_lua)
...
*   [awesome-rust](https://github.com/rust-unofficial/awesome-rust) (_has scattered references to targeting WASM_)
