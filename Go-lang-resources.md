...
*   [halfrost/LeetCode-Go](https://github.com/halfrost/LeetCode-Go) - ![white_check_mark](https://github.githubassets.com/images/icons/emoji/unicode/2705.png) Solutions to LeetCode by Go, 100% test coverage, runtime beats 100% / LeetCode 题解
...
*   [XIU2/CloudflareSpeedTest](https://github.com/XIU2/CloudflareSpeedTest) - ![cloud_with_lightning](https://github.githubassets.com/images/icons/emoji/unicode/1f329.png)「自选优选 IP / 过滤假墙」测试 Cloudflare CDN 延迟和速度，获取最快 IP (IPv4+IPv6)！
...
*   [yuin/goldmark](https://github.com/yuin/goldmark) - ![trophy](https://github.githubassets.com/images/icons/emoji/unicode/1f3c6.png) A markdown parser written in Go. Easy to extend, standard(CommonMark) compliant, well structured.
...
*   [skip2/go-qrcode](https://github.com/skip2/go-qrcode) - ![sparkles](https://github.githubassets.com/images/icons/emoji/unicode/2728.png) QR Code encoder (Go)
...
*   [g3n/engine](https://github.com/g3n/engine) - Go 3D Game Engine ([http://g3n.rocks](http://g3n.rocks))
...
*   [stianeikeland/go-rpio](https://github.com/stianeikeland/go-rpio) - ![electric_plug](https://github.githubassets.com/images/icons/emoji/unicode/1f50c.png) Raspberry Pi GPIO library for go-lang
...
*   [wasmerio/wasmer-go](https://github.com/wasmerio/wasmer-go) - ![hamster](https://github.githubassets.com/images/icons/emoji/unicode/1f439.png)![spider_web](https://github.githubassets.com/images/icons/emoji/unicode/1f578.png) WebAssembly runtime for Go
*   [yanyiwu/gojieba](https://github.com/yanyiwu/gojieba) - "结巴"中文分词的Golang版本
*   [arl/statsviz](https://github.com/arl/statsviz) - ![rocket](https://github.githubassets.com/images/icons/emoji/unicode/1f680.png) Instant live visualization of your Go application runtime statistics (GC, MemStats, etc.) in the browser
*   [h2non/bimg](https://github.com/h2non/bimg) - Go package for fast high-level image processing powered by libvips C library
*   [hu17889/go\_spider](https://github.com/hu17889/go_spider) - \[爬虫框架 (golang)\] An awesome Go concurrent Crawler(spider) framework. The crawler is flexible and modular. It can be expanded to an Individualized crawler easily or you can use the default crawl components only.
...
*   [elliotchance/c2go](https://github.com/elliotchance/c2go) - ![balance_scale](https://github.githubassets.com/images/icons/emoji/unicode/2696.png) A tool for transpiling C to Go.
...
*   [GoBelieveIO/im\_service](https://github.com/GoBelieveIO/im_service) - golang im server
*   [chai2010/go2-book](https://github.com/chai2010/go2-book) - ![books](https://github.githubassets.com/images/icons/emoji/unicode/1f4da.png) 《Go2编程指南》开源图书，重点讲解Go2新特性，以及Go1教程中较少涉及的特性
...
*   [golang-jwt/jwt](https://github.com/golang-jwt/jwt) - Community maintained clone of [https://github.com/dgrijalva/jwt-go](https://github.com/dgrijalva/jwt-go)
*   [yyyar/gobetween](https://github.com/yyyar/gobetween) - ![cloud](https://github.githubassets.com/images/icons/emoji/unicode/2601.png) Modern & minimalistic load balancer for the Сloud era
...
*   [samuel/go-zookeeper](https://github.com/samuel/go-zookeeper) - Native ZooKeeper client for Go. This project is no longer maintained. Please use [https://github.com/go-zookeeper/zk](https://github.com/go-zookeeper/zk) instead.
...
*   [smallnest/go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) - ![zap](https://github.githubassets.com/images/icons/emoji/unicode/26a1.png) Go web framework benchmark
*   [rodrigo-brito/gocity](https://github.com/rodrigo-brito/gocity) - ![bar_chart](https://github.githubassets.com/images/icons/emoji/unicode/1f4ca.png) Code City metaphor for visualizing Go source code in 3D
...
*   [LockGit/gochat](https://github.com/LockGit/gochat) - goim server write by golang !![rocket](https://github.githubassets.com/images/icons/emoji/unicode/1f680.png)
...
*   [40t/go-sniffer](https://github.com/40t/go-sniffer) - ![mag_right](https://github.githubassets.com/images/icons/emoji/unicode/1f50e.png)Sniffing and parsing mysql,redis,http,mongodb etc protocol. 抓包截取项目中的数据库请求并解析成相应的语句。
...
*   [StephenGrider/GoCasts](https://github.com/StephenGrider/GoCasts) - Companion Repo to [https://www.udemy.com/go-the-complete-developers-guide/](https://www.udemy.com/go-the-complete-developers-guide/)
...
*   [go-co-op/gocron](https://github.com/go-co-op/gocron) - Easy and fluent Go cron scheduling. This is a fork from [https://github.com/jasonlvhit/gocron](https://github.com/jasonlvhit/gocron)
...
*   [camptocamp/terraboard](https://github.com/camptocamp/terraboard) - ![earth_africa](https://github.githubassets.com/images/icons/emoji/unicode/1f30d.png) ![clipboard](https://github.githubassets.com/images/icons/emoji/unicode/1f4cb.png) A web dashboard to inspect Terraform States
...
*   [emersion/go-imap](https://github.com/emersion/go-imap) - ![inbox_tray](https://github.githubassets.com/images/icons/emoji/unicode/1f4e5.png) An IMAP library for clients and servers
*   [DataDog/datadog-agent](https://github.com/DataDog/datadog-agent) - Datadog Agent
*   [bradfitz/gomemcache](https://github.com/bradfitz/gomemcache) - Go Memcached client library #golang
*   [tmrts/boilr](https://github.com/tmrts/boilr) - ![zap](https://github.githubassets.com/images/icons/emoji/unicode/26a1.png) boilerplate template manager that generates files or directories from template repositories
...
*   [prometheus-community/elasticsearch\_exporter](https://github.com/prometheus-community/elasticsearch_exporter) - Elasticsearch stats exporter for Prometheus
*   [golang/tour](https://github.com/golang/tour) - \[mirror\] A Tour of Go
*   [yedf/dtm](https://github.com/yedf/dtm) - ![fire](https://github.githubassets.com/images/icons/emoji/unicode/1f525.png)A cross-language distributed transaction manager. Support xa, tcc, saga, transactional messages. 跨语言分布式事务管理器
*   [cch123/golang-notes](https://github.com/cch123/golang-notes) - Go source code analysis(zh-cn)
*   [roseduan/rosedb](https://github.com/roseduan/rosedb) - ![rocket](https://github.githubassets.com/images/icons/emoji/unicode/1f680.png)A fast, stable and embedded k-v storage in pure Golang, supports string, list, hash, set, sorted set. 一个 Go 语言实现的快速、稳定、内嵌的 k-v 存储引擎。
*   [mlogclub/bbs-go](https://github.com/mlogclub/bbs-go) - 基于Golang的开源社区系统。
*   [monochromegane/go\_design\_pattern](https://github.com/monochromegane/go_design_pattern) - Design patterns in Golang.
...
*   [askgitdev/askgit](https://github.com/askgitdev/askgit) - Query git repositories with SQL. Generate reports, perform status checks, analyze codebases. ![mag](https://github.githubassets.com/images/icons/emoji/unicode/1f50d.png) ![bar_chart](https://github.githubassets.com/images/icons/emoji/unicode/1f4ca.png)
...
*   [lileio/lile](https://github.com/lileio/lile) - Easily generate gRPC services in Go ![zap](https://github.githubassets.com/images/icons/emoji/unicode/26a1.png)
...
*   [haxpax/gosms](https://github.com/haxpax/gosms) - ![mailbox_closed](https://github.githubassets.com/images/icons/emoji/unicode/1f4ea.png) Your own local SMS gateway in Go
*   [miguelmota/cointop](https://github.com/miguelmota/cointop) - A fast and lightweight interactive terminal based UI application for tracking cryptocurrencies ![rocket](https://github.githubassets.com/images/icons/emoji/unicode/1f680.png)
...
*   [TwinProduction/gatus](https://github.com/TwinProduction/gatus) - ![rescue_worker_helmet](https://github.githubassets.com/images/icons/emoji/unicode/26d1.png) Gatus - Automated service health dashboard
...
*   [jiujuan/go-collection](https://github.com/jiujuan/go-collection) - ![tulip](https://github.githubassets.com/images/icons/emoji/unicode/1f337.png) awesome awesome go, study golang from basic to proficient
...
*   [k6io/k6](https://github.com/k6io/k6) - A modern load testing tool, using Go and JavaScript - [https://k6.io](https://k6.io)
...
*   [justwatchcom/elasticsearch\_exporter](https://github.com/justwatchcom/elasticsearch_exporter) - Elasticsearch stats exporter for Prometheus
...
*   [gorilla/handlers](https://github.com/gorilla/handlers) - A collection of useful middleware for Go HTTP services & web applications ![customs](https://github.githubassets.com/images/icons/emoji/unicode/1f6c3.png)
...
*   [augmentable-dev/askgit](https://github.com/augmentable-dev/askgit) - Query git repositories with SQL. Generate reports, perform status checks, analyze codebases. ![mag](https://github.githubassets.com/images/icons/emoji/unicode/1f50d.png) ![bar_chart](https://github.githubassets.com/images/icons/emoji/unicode/1f4ca.png)
...
*   [loadimpact/k6](https://github.com/loadimpact/k6) - A modern load testing tool, using Go and JavaScript - [https://k6.io](https://k6.io)
...
*   [loklak/loklak\_go\_api](https://github.com/loklak/loklak_go_api) - Go library client for using the Loklak API
...
*   [samsarahq/thunder](https://github.com/samsarahq/thunder) - ![zap](https://github.githubassets.com/images/icons/emoji/unicode/26a1.png) A Go framework for rapidly building powerful graphql services
...
*   [pravj/geopattern](https://github.com/pravj/geopattern) - ![triangular_ruler](https://github.githubassets.com/images/icons/emoji/unicode/1f4d0.png) Create beautiful generative image patterns from a string in golang.
...
*   [rlmcpherson/s3gof3r](https://github.com/rlmcpherson/s3gof3r) - Fast, concurrent, streaming access to Amazon S3, including gof3r, a CLI. [http://godoc.org/github.com/rlmcpherson/s3gof3r](http://godoc.org/github.com/rlmcpherson/s3gof3r)
...
*   [alecthomas/go\_serialization\_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) - Benchmarks of Go serialization methods
*   [containous/traefik](https://github.com/containous/traefik) - The Cloud Native Edge Router
*   [containous/yaegi](https://github.com/containous/yaegi) - Yaegi is Another Elegant Go Interpreter
*   [kylesliu/awesome-golang-leetcode](https://github.com/kylesliu/awesome-golang-leetcode) - ![memo](https://github.githubassets.com/images/icons/emoji/unicode/1f4dd.png) LeetCode of algorithms with golang solution(updating).
*   [wenjianzhang/go-admin](https://github.com/wenjianzhang/go-admin) - 基于Gin + Vue + Element UI的前后端分离权限管理系统脚手架（包含了：基础用户管理功能，jwt鉴权，代码生成器，RBAC资源控制，表单构建等）文档：[http://doc.zhangwj.com/go-admin-site/](http://doc.zhangwj.com/go-admin-site/) Demo： [http://www.zhangwj.com/#/login](http://www.zhangwj.com/#/login)
...
*   [changkun/go-under-the-hood](https://github.com/changkun/go-under-the-hood) - ![books](https://github.githubassets.com/images/icons/emoji/unicode/1f4da.png) Go Under The Hood: A Source Code Study of Go (1.14, WIP)
...
*   [augmentable-dev/gitqlite](https://github.com/augmentable-dev/gitqlite) - Query git repositories with SQL. Generate reports, perform status checks, analyze codebases. ![mag](https://github.githubassets.com/images/icons/emoji/unicode/1f50d.png) ![bar_chart](https://github.githubassets.com/images/icons/emoji/unicode/1f4ca.png)
...
*   [cloudson/gitql](https://github.com/cloudson/gitql) - ![pill](https://github.githubassets.com/images/icons/emoji/unicode/1f48a.png) A git query language
