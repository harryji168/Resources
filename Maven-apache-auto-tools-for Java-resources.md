...
### [](#to-show-plugin-details-in-configuration)To show plugin details in configuration
...
[](#transitive-dependcies)Transitive Dependcies
-----------------------------------------------
...
[](#generate-a-service-jar-module)Generate a service jar module
---------------------------------------------------------------
