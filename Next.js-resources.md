...
*   [Nitro ![rocket](https://github.githubassets.com/images/icons/emoji/unicode/1f680.png)](https://github.com/williamluke4/nitro) - An Example of a PWA using Nextjs, Material-UI, Typescript and Auth0 ![heartpulse](https://github.githubassets.com/images/icons/emoji/unicode/1f497.png)
...
*   [NextJS Redux-Wrapper Material-UI](https://github.com/joaopaulomoraes/nextjs-with-redux-and-material-ui) - ![nerd_face](https://github.githubassets.com/images/icons/emoji/unicode/1f913.png) A boilerplate NextJS with Redux and Material UI.
*   [Staart](https://github.com/nmaro/staart) - ![sunglasses](https://github.githubassets.com/images/icons/emoji/unicode/1f60e.png) Actively maintained Next.js components library _and_ minimal boilerplate to rapidly get staarted with app with working user accounts based on Ooth.
*   [NextJS TypeScript Starter Kit](https://github.com/deptno/next.js-typescript-starter-kit) - ![tada](https://github.githubassets.com/images/icons/emoji/unicode/1f389.png) TypeScript + NextJS, Styled-jsx, Redux, PostCSS, configurable SEO
...
*   [Nextron](https://github.com/saltyshiomix/nextron) - An Electron with Next.js apps generator ![zap](https://github.githubassets.com/images/icons/emoji/unicode/26a1.png)
...
*   [react-next-boilerplate](https://github.com/react-next-boilerplate/react-next-boilerplate) - ![rocket](https://github.githubassets.com/images/icons/emoji/unicode/1f680.png) A basis for reducing the configuration of your projects with nextJS, best development practices and popular libraries in the developer community.
...
*   [Nextjs Blog Starter](https://creativedesignsguru.com/demo/Nextjs-Blog-Boilerplate/) - ![rocket](https://github.githubassets.com/images/icons/emoji/unicode/1f680.png) The perfect starter code for your blog based on Next.js framework. ![zap](https://github.githubassets.com/images/icons/emoji/unicode/26a1.png) Made with Next.js, TypeScript, ESLint, Prettier, PostCSS, Tailwind CSS.
...
*   [Nextjs Starter Peacock](https://github.com/vickOnRails/next-starter-peacock) - ![peacock](https://github.githubassets.com/images/icons/emoji/unicode/1f99a.png) Beautiful Nextjs portfolio starter for software engineers and designers to show work they're so proud of.
*   [Nextatic](https://github.com/tancredi/nextatic) - ![earth_africa](https://github.githubassets.com/images/icons/emoji/unicode/1f30d.png) Static website multi-language boilerplate with user-editable pages and navigation using Netlify CMS + Next.js + SCSS + Typescript.
*   [Sitemap generator for NextJS & StrAPI](https://github.com/stovv/next-strapi-sitemap) - ![mechanical_arm](https://github.githubassets.com/images/icons/emoji/unicode/1f9be.png) An additional server on express that runs alongside nextjs and regenerates sitemap ( with index sitemap ) and robots.txt files on request from STR API.
...
*   [next-deploy](https://github.com/lone-cloud/next-deploy) - ![rocket](https://github.githubassets.com/images/icons/emoji/unicode/1f680.png) Effortless deployment to AWS and GitHub Pages.
...
*   [njt.now.sh](https://njt.now.sh) - npm jump to ![frog](https://github.githubassets.com/images/icons/emoji/unicode/1f438.png) (package navigation shortcuts you dreamed about). Partially statically-rendered, partially deployed as lambda. Automatically updated on each commit to the [github repo](https://github.com/kachkaev/njt), thanks to Now integration.
...
Found an awesome package, article, blog, video etc.? Send me a pull request! Just follow the [guidelines](/unicodeveloper/awesome-nextjs/blob/master/CONTRIBUTING.md). Thank you!
