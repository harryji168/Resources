...
*   [mesosphere-dc/os](/cicdops/awesome-ciandcd/blob/master/mesosphere.com) As a datacenter operating system, DC/OS is itself a distributed system, a cluster manager, a container platform, and an operating system.
...
*   [Puppet](/cicdops/awesome-ciandcd/blob/master) Build, destroy and rebuild servers on any public or private cloud
...
my email is: [itech001@126.com](mailto:itech001@126.com).