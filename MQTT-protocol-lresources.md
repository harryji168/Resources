...
*   [Mosquitto](http://mosquitto.org/) - _"_The"__ Open Source MQTT Broker.
...
*   [lirc2mqtt](https://github.com/hobbyquaker/lirc2mqtt) - Send and receive infrared via [LIRC](/hobbyquaker/awesome-mqtt/blob/master/www.lirc.org).
...
Contributions welcome! Read the [contribution guidelines](/hobbyquaker/awesome-mqtt/blob/master/contributing.md) first.
